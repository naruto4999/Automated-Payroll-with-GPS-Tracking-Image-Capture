...
test_dataset_directory = "/home/naruto/Kaushal/Programming/machine_learning/dataset/transfer_learning"
...
#Pre-trained Model
vggface_vgg16_base = VGGFace(model='vgg16', include_top=False, input_shape=(224, 224, 3))
...
vggface_vgg16_base.trainable = False
last_layer = vggface_vgg16_base.get_layer('pool5').output

# Build up the new model
inputs = tf.keras.Input(shape=(224, 224, 3))
x = data_augmentation(inputs)
x = vggface_vgg16_base(x)
